...
| [Lab 6 - CI/CD K8s](https://github.com/qsurdez-heigvd/DOP/tree/main/lab06)      | Writing a Docker, compose, CI/CD for a Spring application. Deploying it to K8s with the images pushed to the gitlab registry | Docker 🐋, K8s | 5.5   |
